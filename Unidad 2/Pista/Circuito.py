...
class Juego:
    def __init__(self):
        ...
        self.pista_coords = [
            (280, 550),  # Inicio/Meta Cerca
            (280, 500),  # Subida recta
            (280, 450),
            (280, 350),
            (280, 200),
            (280, 100),
            (280, 50),  # Inicio de curva superior izquierda
            (350, 40),
        ...
        # Checkpoint (Invisible): En la parte superior.
        # Obliga al jugador a ir lejos antes de volver a la meta.
    ...
    def actualizar_movimiento(self):
        ...
        # Lógica de Checkpoint para obligar a dar la vuelta
        if self.checkpoint_rect.collidepoint(self.centro):
            self.checkpoint_activado = True
            # Opcional: feedback visual breve o consola
        ...
        if self.meta_rect.collidepoint(self.centro):
            if self.checkpoint_activado:
                ...
                # Si intenta ganar yendo marcha atrás sin dar la vuelta
                pass
    ...
    def dibujar(self):
        ...
        # Pista (Cosas nuevas asignadas)
        # Líneas gruesas de la pista para mejorar la anchura para asignar circulos que cubran los errores poligonales
